...
Educational example of how I ran Free Energy Perturbation (FEP) calculations with [OpenFE](https://github.com/OpenFreeEnergy/openfe) on AWS 8xGPU instances (using `g5.48xlarge`, NVIDIA A10G, 192 vCPUs).  
