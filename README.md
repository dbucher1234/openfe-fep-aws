...
| `lig_A.sdf … lig_E.sdf` | Ligand files built from smiles via `prep/generate_ligand.py` |
| `ligands.sdf` | Input ligands dcocked and merged into a signle file |
...
| `ddg.out` | Output with relative free energies between compounds |
