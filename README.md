...
Provided an educational example of the ranking of 5 ligands in the T4 Lysozyme L99A (pdb 4W52), completed within a few hours on a 8xGPU instance (`g5.48xlarge`).
