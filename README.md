...
Educational example of how I ran Free Energy Perturbation (FEP) calculations using [OpenFE](https://github.com/OpenFreeEnergy/openfe) on AWS GPU instances (using `g5.48xlarge`, 8× NVIDIA A10G, 192 vCPUs).  
